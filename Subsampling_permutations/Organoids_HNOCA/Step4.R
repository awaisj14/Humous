...
# prepare_lands_ordinal.R
# Prepare LandsS_H object from ordinal-annotated Seurat object (IntH_L_perm_XX.rds)
# Usage: Rscript prepare_lands_ordinal.R <perm_id>
...
source("/home/users/j/javed/humous_reviews/lib_lands.R")
...
outfile <- sprintf("%s/LandsS_H_perm_%02d.rds", outdir, perm_id)
saveRDS(LandsS_H, outfile)
message("Saved LandsS_H to: ", outfile)
